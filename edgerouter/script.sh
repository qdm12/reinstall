...
$cw set interfaces ethernet eth0 address 10.10.10.1/24
...
$cw set port-forward rule 1 forward-to address 10.10.10.2
...
$cw set port-forward rule 2 forward-to address 10.10.10.2
...
$cw set port-forward rule 3 forward-to address 10.10.10.2
...
$cw set port-forward rule 4 forward-to address 10.10.10.2
...
$cw set port-forward rule 5 forward-to address 10.10.10.2
...
$cw set port-forward rule 6 forward-to address 10.10.10.2
...
$cw set port-forward rule 7 forward-to address 10.10.10.2
...
$cw set port-forward rule 8 forward-to address 10.10.10.2
...
$cw set port-forward rule 11 forward-to address 10.10.10.2
...
$cw set port-forward rule 12 forward-to address 10.10.10.2
...
$cw set service dhcp-server shared-network-name ETH0 subnet 10.10.10.0/24 default-router 10.10.10.1
$cw set service dhcp-server shared-network-name ETH0 subnet 10.10.10.0/24 dns-server 10.10.10.2
$cw set service dhcp-server shared-network-name ETH0 subnet 10.10.10.0/24 lease 86400
$cw set service dhcp-server shared-network-name ETH0 subnet 10.10.10.0/24 start 10.10.10.2 stop 10.10.10.127
$cw set service dhcp-server shared-network-name ETH0 subnet 10.10.10.0/24 static-mapping o11 ip-address 10.10.10.3
$cw set service dhcp-server shared-network-name ETH0 subnet 10.10.10.0/24 static-mapping o11 mac-address '18:c0:4d:09:f6:63'
$cw set service dhcp-server shared-network-name ETH0 subnet 10.10.10.0/24 static-mapping pi ip-address 10.10.10.4
$cw set service dhcp-server shared-network-name ETH0 subnet 10.10.10.0/24 static-mapping pi mac-address '4c:ed:fb:70:c3:00'
$cw set service dhcp-server shared-network-name ETH0 subnet 10.10.10.0/24 static-mapping zenarch ip-address 10.10.10.2
$cw set service dhcp-server shared-network-name ETH0 subnet 10.10.10.0/24 static-mapping zenarch mac-address 'd8:5e:d3:0f:8b:85'
...
$cw set service ssh listen-address 10.10.10.1
...
$cw set system name-server 10.10.10.2
